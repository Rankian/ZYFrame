...
public abstract class ZYRecyclerViewAdapter<T> extends BaseRecyclerViewAdapter<T, ZYViewHolder> {
    ...
    public ZYViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (isHeaderViewType(viewType)) {
            return new ZYViewHolder(mHeaderViews.get(viewType));
        }
    ...
    public ZYRecyclerViewAdapter<T> setOnLoadMoreListener(OnLoadMoreListener onLoadMoreListener) {
    ...
    public ZYRecyclerViewAdapter<T> setOnItemLongClickListener(OnItemLongClickListener onItemLongClickListener) {
