...
public class ZYVideoErrorView extends FrameLayout {
    ...
    public ZYVideoErrorView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ZYVideoErrorView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
