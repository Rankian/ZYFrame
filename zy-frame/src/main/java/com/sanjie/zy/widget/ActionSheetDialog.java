...
/**
 * Created by LangSanJie on 2017/3/14.
 */
...
public class ActionSheetDialog {
     ...
     * @return
     */
    public ActionSheetDialog addSheetItems(@NonNull List<SheetItem> items){
        ...
        for (int i = 1; i <= size; i++) {
            ...
            if (size == 1) {
                if (showTitle) {
                    ...
                    textView.setBackgroundResource(R.drawable.selector_actionsheet_last);
                }
            } else {
                if (showTitle) {
                    if (i >= 1 && i < size) {
                        textView.setBackgroundResource(R.drawable.selector_actionsheet_mid);
                    } else {
                        textView.setBackgroundResource(R.drawable.selector_actionsheet_bottom);
                    }
                } else {
    ...
    public enum SheetItemColor {
        Blue("#00C6FA"), Red("#FD4A2E"), Orange("#FD990F");
