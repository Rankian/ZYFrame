package com.sanjie.zy.utils.statusbar;
...
public class ZYStatusBarUtil {
    ...
    public static final int FAKE_STATUS_BAR_VIEW_ID = R.id.statusbar_fake_status_bar_view;
    public static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.statusbar_translucent_view;

    private ZYStatusBarUtil() {
    }
    ...
    public static void setStatusBarColor(Activity activity, int statusColor, int alpha) {
        setStatusBarColor(activity, calculateStatusColor(statusColor, alpha));
    }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if (hideStatusBarBackground) {
                    ...
                    window.setStatusBarColor(calculateStatusColor(COLOR_TRANSLUCENT, DEFAULT_COLOR_ALPHA));
                }
    ...
    public static void setColor(Activity activity, @ColorInt int color) {
        setColor(activity, color, DEFAULT_COLOR_ALPHA);
    }
    ...
    public static void setColorForSwipeBack(Activity activity, int color) {
        setColorForSwipeBack(activity, color, DEFAULT_COLOR_ALPHA);
    }
    ...
    public static void setTranslucent(Activity activity) {
        setTranslucent(activity, DEFAULT_COLOR_ALPHA);
    }
    ...
    public static void setColorForDrawerLayout(Activity activity, DrawerLayout drawerLayout, @ColorInt int color) {
        setColorForDrawerLayout(activity, drawerLayout, color, DEFAULT_COLOR_ALPHA);
    }
    ...
    public static void setColorForDrawerLayoutDiff(Activity activity, DrawerLayout drawerLayout, @ColorInt int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (fakeStatusBarView != null) {
                ...
                fakeStatusBarView.setBackgroundColor(calculateStatusColor(color, DEFAULT_COLOR_ALPHA));
            } else {
                // 添加 statusBarView 到布局中
                contentLayout.addView(createStatusBarView(activity, color), 0);
            }
    ...
    public static void setTranslucentForDrawerLayout(Activity activity, DrawerLayout drawerLayout) {
        setTranslucentForDrawerLayout(activity, drawerLayout, DEFAULT_COLOR_ALPHA);
    }
    ...
    public static void setTranslucentForImageView(Activity activity, View needOffsetView) {
        setTranslucentForImageView(activity, DEFAULT_COLOR_ALPHA, needOffsetView);
    }
    ...
    public static void setTranslucentForImageViewInFragment(Activity activity, View needOffsetView) {
        setTranslucentForImageViewInFragment(activity, DEFAULT_COLOR_ALPHA, needOffsetView);
    }
