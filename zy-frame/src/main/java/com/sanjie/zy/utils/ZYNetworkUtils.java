...
public class ZYNetworkUtils {
     ...
     * @return 网络类型
     * <ul>
     * <li>{@link ZYNetworkUtils.NetworkType#NETWORK_WIFI   } </li>
     * <li>{@link ZYNetworkUtils.NetworkType#NETWORK_4G     } </li>
     * <li>{@link ZYNetworkUtils.NetworkType#NETWORK_3G     } </li>
     * <li>{@link ZYNetworkUtils.NetworkType#NETWORK_2G     } </li>
     * <li>{@link ZYNetworkUtils.NetworkType#NETWORK_UNKNOWN} </li>
     * <li>{@link ZYNetworkUtils.NetworkType#NETWORK_NO     } </li>
     * </ul>
     */
