...
public class ZYDensityUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = ZYFrame.getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        final float fontScale = ZYFrame.getDisplayMetrics().scaledDensity;
    ...
    public static int getScreenWidth() {
        return ZYFrame.getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return ZYFrame.getDisplayMetrics().heightPixels;
    }
    ...
    public static int getScreenRealHeight() {
        int h;
        WindowManager winMgr = (WindowManager) ZYFrame.getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = ZYFrame.getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources resources = ZYFrame.getResources();
